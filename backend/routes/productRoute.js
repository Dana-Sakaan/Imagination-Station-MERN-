...
const { createProduct, updateProduct, deleteProduct, getProduct, searchProducts, getProducts, productsWithOffer, productsOutOfStock, getProductss} = require("../controllers/productCont")
