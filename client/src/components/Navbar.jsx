...
function Navbar() {
  return (
    <nav className="bg-secondary text-black w-[100%]">
      {/* top navbar */}
      <div className="flex justify-between p-4 xs:p-8 xs:pb-3 xs:pt-5 ss:justify-around">
        <div>
          <Link to="/" className="flex">
            ...
            <p className="bg-[linear-gradient(90deg,_rgba(254,110,8,1)_29%,_rgba(63,165,184,1)_62%)] bg-clip-text text-transparent mt-3 ml-2 text-lg">Imagination Station</p>
          </Link>
        </div>
        <div className="flex justify-center w-[50%] gap-1">
          <input
            className=" w-[70%] rounded-lg p-1"
            type="text"
            placeholder="Search..."
          />
